...
put(T("Gateway API + Envoy Gateway + cert-manager","One front door. Envoy Gateway is the maintained controller. ingress-nginx was the most-used Ingress controller; Kubernetes retired it March 2026.",[gw,egw,cm]),["p-ingress"]);
...
put(T("AWS NLB + Gateway API","L4 VIP in front of L7. MetalLB + Gateway API on prem. Do not pair a new cluster with retired ingress-nginx.",[nlb,gw]),["p-lb"]);
})(window.IDP_DATA);
